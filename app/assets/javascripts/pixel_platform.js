...
var game = new Phaser.Game(1200, 320, Phaser.AUTO, 'pixel_platform_Div');
...
// Define the 3 default Phaser functions:
    ...
    create: function() {
        ...
        //('1') spritesheet/tileset name inside of Tiled Map Editor || ('2') key in preload function
        map.addTilesetImage('mario_tileset', 'mario_tileset');
    ...
    update: function() {
        ...
        game.physics.arcade.collide(this.player, map);
